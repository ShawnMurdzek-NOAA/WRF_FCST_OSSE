...
#if [ ${FULLCYC} -eq 0 ]; then
#  if [ -r ${DATAROOT}/${time_00hago}/wrfprd/wrfout_d01_${time_str} ]; then
#    ${ECHO} " Cycled smoke using ${time_00hago}/wrfprd/wrfout_d01_${time_str}"
#    ${LN} -s ${DATAROOT}/${time_00hago}/wrfprd/wrfout_d01_${time_str} ./wrfout_smoke
#    ${ECHO} " Cycle ${YYYYMMDDHH}: Smoke background=${time_00hago}/wrfprd/wrfout_d01_${time_str}"
